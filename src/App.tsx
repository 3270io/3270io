...
function App() {
  ...
  const products = [
    ...
    },
    {
      ...
      description: "Web-based 3270 terminal interface in Go. Drive sessions with AI Chat — read screens, run chaos discovery, and map each screen's business purpose — then record and replay 3270Connect-compatible workflows.",
